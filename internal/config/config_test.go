...
func TestLoad_Defaults(t *testing.T) {
	...
	if cfg.DBPassword != "trader5" {
		t.Errorf("DBPassword = %q, want %q", cfg.DBPassword, "trader5")
	}
...
func TestDSN_DefaultValues(t *testing.T) {
	...
	dsn := cfg.DSN()
	expected := "host=localhost port=5432 user=trader password=trader5 dbname=trading_platform sslmode=disable"
	if dsn != expected {
